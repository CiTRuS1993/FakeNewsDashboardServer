...
class testUserManager(TestCase):
    ...
    def test_register(self):
        self.assertTrue(self.UserManagerFacade.register("sapir", "sap3232"))
        self.assertTrue(self.UserManagerFacade.validate_user("sapir", "sap3232"))
        self.assertFalse(self.UserManagerFacade.validate_user("yarin", "sap3232"))
        self.assertFalse(self.UserManagerFacade.validate_user("sapir", "hadar12"))

    def test_admin_exists(self):
        self.assertFalse(self.UserManagerFacade.admin_exists("sapir", "sap3232"))
    ...
    def test_tag_tweet(self):
        self.assertFalse(self.UserManagerFacade.tag_tweet("sapir", 2))
    ...
    def test_is_admin(self):
        self.assertFalse(self.UserManagerFacade.is_admin("sapir"))

    def test_validate_user(self):
        self.assertTrue(self.UserManagerFacade.validate_user("sapir", "sap3232"))

    def test_classify_tweets(self):
        self.assertFalse(self.UserManagerFacade.classify_tweets("sapir",1))
